...
const speakers: Speaker[] = [
	{
		...
		imageUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/Benj%20-%20200X200.jpeg",
	...
	},
	{
		...
		company: "Qobra",
		companyLogoUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/qobra-logo.jpeg",
		imageUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/Antoine%20Fort%20(CEO).jpg",
	...
	},
	{
		...
		company: "Zenchef",
		companyLogoUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/zenchef%20logo.png",
		imageUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/Pierre%20Antoine%20Canova.jpeg",
	...
	},
	{
		...
		company: "Aircall",
		companyLogoUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/aircall_logo_black_rgb-Maggie-Mccarthy-1440x543.png",
		imageUrl:
			"https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/Lea%20Lejolly.jpeg",
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					<div className="inline-block mb-4 px-3 py-1 rounded-full bg-ocobo-primary/10 border border-ocobo-primary/20">
						<span className="text-ocobo-primary text-xs font-bold uppercase tracking-widest">
							Intervenants
						</span>
					</div>
					<h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-4 tracking-tight">
						Les voix du Revenue Forward
					</h2>
					<p className="text-slate-600 text-lg max-w-2xl mx-auto">
						Rencontrez les leaders qui façonnent les stratégies de croissance
						des plus belles entreprises de la French Tech.
					</p>
				</div>
						...
						>
							<div className="relative rounded-[2.5rem] overflow-hidden bg-white/40 border border-white/60 backdrop-blur-md shadow-lg transition-all duration-500 group-hover:shadow-2xl group-hover:-translate-y-2 h-full">
								...
								<div className="p-8 text-center flex flex-col items-center">
									...
									<p className="text-ocobo-primary font-semibold text-sm mb-4">
										{speaker.role}
									</p>
