...
const Location: React.FC<LocationProps> = ({
  venueName = 'Morning Bourse',
  imageUrl = 'https://27107933.fs1.hubspotusercontent-eu1.net/hubfs/27107933/Morning%20Bourse.avif',
  imageAlt = 'Morning Bourse - Paris',
  description = 'Situé au cœur du quartier historique de la finance, face au majestueux Palais Brongniart, Morning Bourse nous accueille dans un cadre prestigieux et inspirant. Un lieu iconique, alliant héritage architectural et modernité, pour dessiner ensemble les contours du revenu de demain.',
  address = '4 Pl. de la Bourse\n75002 Paris',
  dateTime = '12 Fév 2026\nÀ partir de 19h00',
  mapsUrl = 'https://maps.app.goo.gl/oC8f79GkaKof4rjv9',
}) => {
  return (
        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 border border-white shadow-xl">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">{venueName}</h2>
